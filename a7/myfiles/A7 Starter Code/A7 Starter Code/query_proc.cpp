...
void processToken (string inputQuery, vector<string>&queryBag, int bagCap) {
    ...
    string s7 = "curl -s https://api.datamuse.com/words?rel_syn=";
    string s8 = "&max=5"; 
...
vector<string> generateQueryBag (vector<string> query, int bagCap) {
    
    //update this
    vector<string> stopWords = {"?", "!", ",", ";", ".", "0o", "0s", "3a", "3b", "3d", "6b", "6o", "a", "a1", "a2", "a3", "a4", "ab", "able", "about", "above", 
...
{
    vector<string> queryList = {"What", "is", "the", "meaning", "of", "life", "according", "to", "Mahatama", "Gandhi", "?"};
    int bagCap = 5*queryList.size(); //modify if needed
    vector<string> qb = generateQueryBag(queryList, bagCap);
