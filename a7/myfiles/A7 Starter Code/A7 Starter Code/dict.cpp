...
TrieNode::TrieNode(long double freq, bool eow)
{
    children = new TrieNode *[92];
    for (int i = 0; i < 92; i++)
    {
...
void Trie::insert(string word, long double count, int b_code, int pg, int para)
{
    TrieNode *temp = root;
...
void Dict::insert_sentence(int book_code, int page, int paragraph, int sentence_no, string sentence, long double count, int &num_word)
{
    string separators = " .,-:!\"\'()?[];@";
    string word = "";
...
long double Dict::get_word_count(string word)
{
