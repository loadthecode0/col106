...
int main()
{
    ...
    string question = "What did his brother entertained about colonel Watson?";
    ...
    */
    ...
    // // cout << "get_top_k fault" << endl;
    // // cout << "hello3\n";
    //Node *head = qna_tool.query(question, "my_file");
    //Node *head = qna_tool.get_top_k_para(question,8);
    // // cout << "hello4\n";
    // // cout << "get_top_k no fault" << endl;
    // vector<string> paras;
    // while (head != nullptr)
    // {
